...
#ifndef STARTUPF334_H_
#define STARTUPF334_H_
...
extern uint32_t __ccmidata;
extern uint32_t __ccmidata_start__;
extern uint32_t __ccmidata_end__;
// CCMRAM - END
